...
const Conv2DShape conv_shapes[] = {
    ...
    // MobileNetV2 depthwise separable (DW channels = IC)
    {1,  32,  112, 112,  32, 3, 3, 1, 1, "MBNet-DW-32"},
    {1,  64,  112, 112,  64, 3, 3, 2, 1, "MBNet-DW-64-s2"},
    {1,  96,   56,  56,  96, 3, 3, 1, 1, "MBNet-DW-96"},
    {1, 128,   56,  56, 128, 3, 3, 1, 1, "MBNet-DW-128"},
    {1, 128,   28,  28, 128, 3, 3, 1, 1, "MBNet-DW-128-28"},
    {1, 160,   14,  14, 160, 3, 3, 1, 1, "MBNet-DW-160"},
    {1, 192,   14,  14, 192, 3, 3, 2, 1, "MBNet-DW-192-s2"},
    {1, 320,    7,   7, 320, 3, 3, 1, 1, "MBNet-DW-320"},
    // EfficientNet-like shapes
    {1,  40,  160, 160,  40, 3, 3, 1, 1, "EffNet-DW-40"},
    {1,  80,   80,  80,  80, 3, 3, 1, 1, "EffNet-DW-80"},
    {1, 112,   40,  40, 112, 3, 3, 1, 1, "EffNet-DW-112"},
    {1, 192,   20,  20, 192, 3, 3, 1, 1, "EffNet-DW-192"},
    // Winograd F(2x2, 3x3) test shapes (OH,OW >= 8)
    {1,  64,   32,  32,  64, 3, 3, 1, 1, "Winograd-32x32"},
    {1, 128,   16,  16, 128, 3, 3, 1, 1, "Winograd-16x16"},
    {1, 256,    8,   8, 256, 3, 3, 1, 1, "Winograd-8x8"},
    // VGG-like large shapes
    {1,  64,  224, 224, 128, 3, 3, 1, 1, "VGG-3x3-128"},
    {1, 128,  112, 112, 256, 3, 3, 1, 1, "VGG-3x3-256"},
    {1, 256,   56,  56, 512, 3, 3, 1, 1, "VGG-3x3-512"},
    // Batch-4 inference (multi-batch)
    {4,  64,   56,  56,  64, 3, 3, 1, 1, "Batch4-3x3-64"},
    {4, 128,   28,  28, 128, 3, 3, 1, 1, "Batch4-3x3-128"},
};
